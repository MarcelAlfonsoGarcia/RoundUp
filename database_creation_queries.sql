...
INSERT INTO users (firstName, lastName, email, campus) VALUES ('Test', 'Dummy', 'test.dummy@pomona.edu', 'POM');
INSERT INTO users (firstName, lastName, email, campus) VALUES ('Marcel', 'Alfonso Garcia', 'magb2017@mymail.pomona.edu', 'POM');
INSERT INTO users (firstName, lastName, email, campus) VALUES ('Jennifer', 'Zecena', 'zecena22@students.claremontmckenna.edu', 'CMC');
INSERT INTO users (firstName, lastName, email, campus) VALUES ('Pei Pei', 'Barth Wu', 'mbpa2018@mymail.pomona.edu', 'POM');
INSERT INTO users (firstName, lastName, email, campus) VALUES ('Hussein', 'Faara', 'hfaa2017@mymail.pomona.edu', 'POM');

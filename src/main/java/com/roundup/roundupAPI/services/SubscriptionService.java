...
public class SubscriptionService {
	...
	*/
	public void addSubscription(int followerID, int followedID){
	  /*
	    1. Pass the subscription information to the data access layer and tell it to add a new subscription to the database.
	...
	*/
	...
	/*
	  1. Pass the subscription id to the data access layer and tell it to delete the subscription from the database.
	  2. Create an subscription object with the provided subscription information.
	  3. Return the Subscription object.
	*/

...
public class RSVPService {
	 ...
	 * @param: time the time at which the user rsvp'd This method adds a new event
	 *              to the database
	 */
	public void addRsvp(String email, String name, int eventID) {
		/*
		 * 1. Pass the rsvp information to the data access layer and tell it to add a
		 * new rsvp to the database. 2. Create an rsvp object with the provided rsvp
		 * information. 3. Return the rsvp object.
		 */
		// current time
	...
	public void deleteRsvp(String email, int eventID) {
		/*
		 * 1. Pass the rsvp id to the data access layer and tell it to delete the rsvp
		 * from the database. 2. Create an rsvp object with the provided rsvp
		 * information. 3. Return the RSVP object.
		 */

...
public class EventService {
	 ...
	 */
	public JSONObject addEvent(int userID, String description, Timestamp eventTime, String poster, String name,
			String location, Set<String> tags) {
		/*
		 * 1. Pass the event information to the data access layer and tell it to add a
		 * new event to the database. 2. Create an event object with the provided event
		 * information. 3. Return the event object.
		 */
	...
	public JSONObject getEvent(int eventID) {
		/*
		 * 1. Pass the event id to the data access layer and tell it to retrieve
		 * specific event from the database. 2. Create an event object with the
		 * retrieved information. 3. Return the event object.
		 */
	...
	public JSONObject updateEvent(int eventID, int userId, String description, Timestamp eventTime, String name,
			String location, Set<String> tags) {
		/*
		 * 1. Pass the event information to the data access layer and tell it to update
		 * the event information accordingly. 2. Create an event object with the
		 * provided event information. 3. Return the event object.
		 */
	...
	public void deleteEvent(int eventID, int userID) {
		/*
		 * 1. Pass the event id to the data access layer and tell it to delete the event
		 * from the database. 2. Create an event object with the provided event
		 * information. 3. Return the Event object.
		 */
	...
	public JSONObject getEventsByTag(Set<String> tags, String status) {
		/*
		 * 1. Pass the tags and status to the database access layer and retrieve events
		 * that satify them. 2. Create Event objects with the given information. 3.
	...
	public JSONObject getAttendees(int eventID) {
		/*
		 * 1. Passes the event id to the data access layer and asks it for rsvps with
		 * the provided event id. 2. Asks the data acess layer for information on users
		 * with the retrieved user ids. 3. If successful, it creates user objects with
		 * the proided information and, and adds them to a list. 4. Return the list of
		 * User objects.
		 */

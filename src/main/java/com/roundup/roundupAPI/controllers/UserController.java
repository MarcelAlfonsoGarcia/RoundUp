...
public class UserController {
	...
	public JSONObject createUser(@RequestBody JSONObject body) {
		/*
		 * 1. Get UserService instance 2. Retrieve new user information 3. Return JSON
	 ...
	 * 
	 * This method handles requests with the /users/login route as attempts to log
	...
	public JSONObject login(@RequestBody JSONObject body) {
		/*
		 * 1. Get UserService instance to check user credentials. 2. If successful,
		 * retrieve user information and token 3. Return JSON serialized User object and
		 * token
		 */
		String email = (String) body.get("email");
		String password = (String) body.get("password");
	...
	public JSONObject getUser(@PathVariable("uID") int uID) {
		/*
		 * 1. Get UserService instance to retrieve user information. 2. Return JSON
		 * serialized User object
		 */
	...
	public void deleteUser(@PathVariable("uID") int uID) {
		/*
		 * 1. Get UserService instance to delete a user. 2. retrieve deleted user
		 * information 3. Return JSON serialized User object
		 */
	...
	public JSONObject updateUser(@PathVariable("uID") int uID, @RequestBody JSONObject body) {
		/*
		 * 1. Get UserService instance to update a user's information. 2. retrieve new
		 * user information 3. Return JSON serialized User object
		 */
		String firstName = (String) body.get("firstName");
		String lastName = (String) body.get("lastName");
		String email = (String) body.get("email");
	 ...
	 * 
	 * This method handles GET requests with the /users/uID/rsvps route as attempts
	 ...
	 * 
	 * This method handles GET requests with the /users/uID/subscriptions routes as
	...
	public JSONObject getUserSubscriptions(@PathVariable("uID") int uID) {
		/*
		 * 1. Get UserService instance to retrieve user subscriptions. 2. Return JSON
		 * serialized Subscription objects
		 */
	 ...
	 * 
	 * This method handles GET requests with the /users/uID/subscribers routes as
	...
	public JSONObject getUserSubscribers(@PathVariable("uID") int uID) {
		/*
		 * 1. Get UserService instance to retrieve user subscribers. 2. Return JSON
